...
interface NavItem {
  ...
  personas?: ("student" | "job_seeker")[]; // if undefined, shown to all
}
...
export function DashboardNav({ persona = "job_seeker" }: { persona?: "student" | "job_seeker" }) {
  ...
  return (
    <nav className="w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 min-h-screen p-4 flex flex-col">
      <div className="mb-8 px-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="text-sm font-bold text-gray-900 dark:text-gray-100">Career Ladder</h1>
            <p className="text-[10px] text-gray-500 dark:text-gray-400">AI Career Services</p>
          </div>
        </div>
      </div>
